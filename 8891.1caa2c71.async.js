...
`,"getStyles"),Wt=wt,D=(0,r.eW)(function(t,e){return(0,T.Mu)(t,e)},"drawRect"),Tt=(0,r.eW)(function(t,e){const c=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),s=t.append("g");s.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),s.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function u(f){const _=(0,R.Nb1)().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);f.append("path").attr("class","mouth").attr("d",_).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}(0,r.eW)(u,"smile");function h(f){const _=(0,R.Nb1)().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);f.append("path").attr("class","mouth").attr("d",_).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}(0,r.eW)(h,"sad");function g(f){f.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return(0,r.eW)(g,"ambivalent"),e.score>3?u(s):e.score<3?h(s):g(s),c},"drawFace"),ot=(0,r.eW)(function(t,e){const i=t.append("circle");return i.attr("cx",e.cx),i.attr("cy",e.cy),i.attr("class","actor-"+e.pos),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("r",e.r),i.class!==void 0&&i.attr("class",i.class),e.title!==void 0&&i.append("title").text(e.title),i},"drawCircle"),ct=(0,r.eW)(function(t,e){return(0,T.yU)(t,e)},"drawText"),Et=(0,r.eW)(function(t,e){function i(s,u,h,g,f){return s+","+u+" "+(s+h)+","+u+" "+(s+h)+","+(u+g-f)+" "+(s+h-f*1.2)+","+(u+g)+" "+s+","+(u+g)}(0,r.eW)(i,"genPoints");const c=t.append("polygon");c.attr("points",i(e.x,e.y,50,20,7)),c.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,ct(t,e)},"drawLabel"),Mt=(0,r.eW)(function(t,e,i){const c=t.append("g"),s=(0,T.kc)();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=i.width*e.taskCount+i.diagramMarginX*(e.taskCount-1),s.height=i.height,s.class="journey-section section-type-"+e.num,s.rx=3,s.ry=3,D(c,s),ut(i)(e.text,c,s.x,s.y,s.width,s.height,{class:"journey-section section-type-"+e.num},i,e.colour)},"drawSection"),ht=-1,St=(0,r.eW)(function(t,e,i){const c=e.x+i.width/2,s=t.append("g");ht++;const u=300+5*30;s.append("line").attr("id","task"+ht).attr("x1",c).attr("y1",e.y).attr("x2",c).attr("y2",u).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Tt(s,{cx:c,cy:300+(5-e.score)*30,score:e.score});const h=(0,T.kc)();h.x=e.x,h.y=e.y,h.fill=e.fill,h.width=i.width,h.height=i.height,h.class="task task-type-"+e.num,h.rx=3,h.ry=3,D(s,h);let g=e.x+14;e.people.forEach(f=>{const _=e.actors[f].color,x={cx:g,cy:e.y,r:7,fill:_,stroke:"#000",title:f,pos:e.actors[f].position};ot(s,x),g+=10}),ut(i)(e.task,s,h.x,h.y,h.width,h.height,{class:"task"},i,e.colour)},"drawTask"),$t=(0,r.eW)(function(t,e){(0,T.O)(t,e)},"drawBackgroundRect"),ut=function(){function t(s,u,h,g,f,_,x,m){const n=u.append("text").attr("x",h+f/2).attr("y",g+_/2+5).style("font-color",m).style("text-anchor","middle").text(s);c(n,x)}(0,r.eW)(t,"byText");function e(s,u,h,g,f,_,x,m,n){const{taskFontSize:a,taskFontFamily:l}=m,d=s.split(/<br\s*\/?>/gi);for(let p=0;p<d.length;p++){const o=p*a-a*(d.length-1)/2,A=u.append("text").attr("x",h+f/2).attr("y",g).attr("fill",n).style("text-anchor","middle").style("font-size",a).style("font-family",l);A.append("tspan").attr("x",h+f/2).attr("dy",o).text(d[p]),A.attr("y",g+_/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),c(A,x)}}(0,r.eW)(e,"byTspan");function i(s,u,h,g,f,_,x,m){const n=u.append("switch"),l=n.append("foreignObject").attr("x",h).attr("y",g).attr("width",f).attr("height",_).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");l.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(s),e(s,n,h,g,f,_,x,m),c(l,x)}(0,r.eW)(i,"byFo");function c(s,u){for(const h in u)h in u&&s.attr(h,u[h])}return(0,r.eW)(c,"_setTextAttrs"),function(s){return s.textPlacement==="fo"?i:s.textPlacement==="old"?t:e}}(),Pt=(0,r.eW)(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics"),G={drawRect:D,drawCircle:ot,drawSection:Mt,drawText:ct,drawLabel:Et,drawTask:St,drawBackgroundRect:$t,initGraphics:Pt},It=(0,r.eW)(function(t){Object.keys(t).forEach(function(i){H[i]=t[i]})},"setConf"),I={};function yt(t){const e=(0,r.nV)().journey;let i=60;Object.keys(I).forEach(c=>{const s=I[c].color,u={cx:20,cy:i,r:7,fill:s,stroke:"#000",pos:I[c].position};G.drawCircle(t,u);const h={x:40,y:i+7,fill:"#666",text:c,textMargin:e.boxTextMargin|5};G.drawText(t,h),i+=20})}(0,r.eW)(yt,"drawActorLegend");var H=(0,r.nV)().journey,N=H.leftMargin,At=(0,r.eW)(function(t,e,i,c){const s=(0,r.nV)().journey,u=(0,r.nV)().securityLevel;let h;u==="sandbox"&&(h=(0,R.Ys)("#i"+e));const g=u==="sandbox"?(0,R.Ys)(h.nodes()[0].contentDocument.body):(0,R.Ys)("body");$.init();const f=g.select("#"+e);G.initGraphics(f);const _=c.db.getTasks(),x=c.db.getDiagramTitle(),m=c.db.getActors();for(const o in I)delete I[o];let n=0;m.forEach(o=>{I[o]={color:s.actorColours[n%s.actorColours.length],position:n},n++}),yt(f),$.insert(0,0,N,Object.keys(I).length*50),Ct(f,_,0);const a=$.getBounds();x&&f.append("text").text(x).attr("x",N).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);const l=a.stopy-a.starty+2*s.diagramMarginY,d=N+a.stopx+2*s.diagramMarginX;(0,r.v2)(f,l,d,s.useMaxWidth),f.append("line").attr("x1",N).attr("y1",s.height*4).attr("x2",d-N-4).attr("y2",s.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");const p=x?70:0;f.attr("viewBox",`${a.startx} -25 ${d} ${l+p}`),f.attr("preserveAspectRatio","xMinYMin meet"),f.attr("height",l+p+25)},"draw"),$={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:(0,r.eW)(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:(0,r.eW)(function(t,e,i,c){t[e]===void 0?t[e]=i:t[e]=c(i,t[e])},"updateVal"),updateBounds:(0,r.eW)(function(t,e,i,c){const s=(0,r.nV)().journey,u=this;let h=0;function g(f){return(0,r.eW)(function(x){h++;const m=u.sequenceItems.length-h+1;u.updateVal(x,"starty",e-m*s.boxMargin,Math.min),u.updateVal(x,"stopy",c+m*s.boxMargin,Math.max),u.updateVal($.data,"startx",t-m*s.boxMargin,Math.min),u.updateVal($.data,"stopx",i+m*s.boxMargin,Math.max),f!=="activation"&&(u.updateVal(x,"startx",t-m*s.boxMargin,Math.min),u.updateVal(x,"stopx",i+m*s.boxMargin,Math.max),u.updateVal($.data,"starty",e-m*s.boxMargin,Math.min),u.updateVal($.data,"stopy",c+m*s.boxMargin,Math.max))},"updateItemBounds")}(0,r.eW)(g,"updateFn"),this.sequenceItems.forEach(g())},"updateBounds"),insert:(0,r.eW)(function(t,e,i,c){const s=Math.min(t,i),u=Math.max(t,i),h=Math.min(e,c),g=Math.max(e,c);this.updateVal($.data,"startx",s,Math.min),this.updateVal($.data,"starty",h,Math.min),this.updateVal($.data,"stopx",u,Math.max),this.updateVal($.data,"stopy",g,Math.max),this.updateBounds(s,h,u,g)},"insert"),bumpVerticalPos:(0,r.eW)(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:(0,r.eW)(function(){return this.verticalPos},"getVerticalPos"),getBounds:(0,r.eW)(function(){return this.data},"getBounds")},tt=H.sectionFills,dt=H.sectionColours,Ct=(0,r.eW)(function(t,e,i){const c=(0,r.nV)().journey;let s="";const u=c.height*2+c.diagramMarginY,h=i+u;let g=0,f="#CCC",_="black",x=0;for(const[m,n]of e.entries()){if(s!==n.section){f=tt[g%tt.length],x=g%tt.length,_=dt[g%dt.length];let l=0;const d=n.section;for(let o=m;o<e.length&&e[o].section==d;o++)l=l+1;const p={x:m*c.taskMargin+m*c.width+N,y:50,text:n.section,fill:f,num:x,colour:_,taskCount:l};G.drawSection(t,p,c),s=n.section,g++}const a=n.people.reduce((l,d)=>(I[d]&&(l[d]=I[d]),l),{});n.x=m*c.taskMargin+m*c.width+N,n.y=h,n.width=c.diagramMarginX,n.height=c.diagramMarginY,n.colour=_,n.fill=f,n.num=x,n.actors=a,G.drawTask(t,n,c),$.insert(n.x,n.y,n.x+n.width+c.taskMargin,300+5*30)}},"drawTasks"),ft={setConf:It,draw:At},Vt={parser:Q,db:lt,renderer:ft,styles:Wt,init:(0,r.eW)(t=>{ft.setConf(t.journey),lt.clear()},"init")}}}]);
